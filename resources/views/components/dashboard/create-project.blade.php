<div class="offcanvas offcanvas-bottom" tabindex="-1" id="createProject" aria-labelledby="offcanvasBottomLabel">
    ...
    <div class="offcanvas-body pb-32 card">
        ...
        <div class="alert alert-success-create light alert-dismissible fade show mb-10 mt-5" role="alert" style="display:none ">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close_success">
              <span class="icon-close2 icon-close-popup" data-bs-dismiss="offcanvas" aria-label="Close_success"></span>
            </button>
          </div>
        
        
          <div class="alert alert-danger-create light alert-dismissible fade show mb-10 mt-5" role="alert" style="display:none ">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
