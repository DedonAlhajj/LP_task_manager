...
<div class="offcanvas show-create offcanvas-bottom" tabindex="-1" id="createProject" aria-labelledby="offcanvasBottomLabel">
...
<div class="alert alert-success light alert-dismissible fade show mb-10 mt-5 alert-success-create" role="alert" style="display:none ">
...
<div class="alert alert-danger light alert-dismissible fade show mb-10 mt-5  alert-danger-create " role="alert" style="display:none " >
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
