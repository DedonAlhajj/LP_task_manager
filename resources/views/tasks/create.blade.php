    ...
    <div class="app-content style-2">
        <div class="tf-container">
            ...
            <div class="mt-24">
                ...
                <input type="text" name="name" id="name" placeholder="Wireframe for NFT Landing Page" class="mt-16">
            </div>
            <div class="mt-20">
                    ...
                    <div class="dropdown" >
                        <div class="timeline-item-date gap-12 dropdown-backdrop dropdown-start-date" data-bs-toggle="dropdown" aria-haspopup="true">
                            ...
                            <div class="content">
                                ...
                                <div class="mt-2 body-4 fw-5 text-black-7 valDate-start" id="start_date">December 25</div>
                            </div>
                        </div>
                    ...
                    <div class="dropdown">
                        <div class="timeline-item-date gap-12 dropdown-backdrop dropdown-due-date" data-bs-toggle="dropdown" aria-haspopup="true">
                            ...
                            <div class="content">
                                ...
                                <div class="mt-2 body-4 fw-5 text-black-7 valDate-due" id="end_date">December 31</div>
                            </div>
                        </div>
                        <div class="dropdown-menu dropdown-calendar">
            ...
            <div class="mt-24 list-desc-project-style2">
                ...
                <div class="right h9 text-black-5">
                    <input type="text" placeholder="Add task description" id="description" name="description" >
                </div>
            </div>
            <div class="mt-20 list-desc-project-style2">
                ...
                <div class="right h9 text-black-5">
                    <select name="status" class="right h9 text-black-5" id="status">
                        <option value="New" class="task-status style-2 type-1"><a href="javascript:void(0);" class="task-status style-2 type-1">New</a>
                        </option>
                        <option value="InProgress" class="task-status style-2 type-2"><a href="javascript:void(0);" class="task-status style-2 type-2">InProgress</a></option>
                        <option value="Completed" class="task-status style-2 type-3">Backlog</a>><a href="javascript:void(0);" class="task-status style-2 type-3">Completed</a></option>
                    </select>
                </div>
            </div>
            ...
            <div class="footer-fixed button">
                <button class="tf-btn primary" id="submit-btn" data-id="{{ $project->id }}"  type="submit">Done</button>
            </div>
            </form>
        </div>
    </div>
